...
public class CraftingRecipes
{
  public static void addCrafts()
  {
    MD.game.crafts.add(new CraftingRecipe(new String[][] {
      ...
      new int[] { 0, 1, 2, 0, 1, 2, 0, 1, 2 }, new int[] {
      0, 0, 0, 1, 1, 1, 2, 2, 2 }));
    MD.game.crafts
    ...
    MD.game.crafts.add(new CraftingRecipe(new String[][] {
      ...
      { "Wooden Planks", "", "Wooden Planks" }, 
      { "Wooden Planks", "Wooden Planks", "Wooden Planks" } }, 
      new ChestItem(1), new int[1], new int[1]));
    ...
    MD.game.crafts.add(new CraftingRecipe(new String[][] { { "", "", "" }, 
      { "Wooden Planks", "Stick", "Stick" }, { "", "", "" } }, 
      new WoodenShovelItem(), new int[1], new int[1]));
    MD.game.crafts.add(new CraftingRecipe(new String[][] { { "", "", "" }, 
      { "Cobblestone", "Stick", "Stick" }, { "", "", "" } }, 
      new StoneShovelItem(), new int[1], new int[1]));
    MD.game.crafts.add(new CraftingRecipe(new String[][] { { "", "", "" }, 
      { "Iron Ingot", "Stick", "Stick" }, { "", "", "" } }, 
      new IronShovelItem(), new int[1], new int[1]));
    MD.game.crafts.add(new CraftingRecipe(new String[][] { { "", "", "" }, 
      { "Diamond", "Stick", "Stick" }, { "", "", "" } }, 
      new DiamondShovelItem(), new int[1], new int[1]));
    MD.game.crafts.add(new CraftingRecipe(new String[][] {
      { "Wooden Planks", "Wooden Planks", "" }, 
      { "Wooden Planks", "Stick", "Stick" }, { "", "", "" } }, 
      new WoodenAxeItem(), new int[1], new int[1]));
    MD.game.crafts.add(new CraftingRecipe(new String[][] {
      { "Cobblestone", "Cobblestone", "" }, 
      { "Cobblestone", "Stick", "Stick" }, { "", "", "" } }, 
      new StoneAxeItem(), new int[1], new int[1]));
    MD.game.crafts.add(new CraftingRecipe(new String[][] {
      { "Iron Ingot", "Iron Ingot", "" }, 
      { "Iron Ingot", "Stick", "Stick" }, { "", "", "" } }, 
      new IronAxeItem(), new int[1], new int[1]));
    MD.game.crafts.add(new CraftingRecipe(new String[][] {
      { "Diamond", "Diamond", "" }, { "Diamond", "Stick", "Stick" }, 
      { "", "", "" } }, new DiamondAxeItem(), new int[1], 
      new int[1]));
    ...
    MD.game.crafts.add(new CraftingRecipe(new String[][] { { "", "", "" }, 
      ...
      new StoneSwordItem(), new int[1], new int[1]));
    MD.game.crafts.add(new CraftingRecipe(new String[][] { { "", "", "" }, 
      { "Iron Ingot", "Iron Ingot", "Stick" }, { "", "", "" } }, 
      new IronSwordItem(), new int[1], new int[1]));
    MD.game.crafts.add(new CraftingRecipe(new String[][] { { "", "", "" }, 
      { "Diamond", "Diamond", "Stick" }, { "", "", "" } }, 
      new DiamondSwordItem(), new int[1], new int[1]));
    MD.game.crafts.add(new CraftingRecipe(new String[][] {
    ...
    MD.game.crafts.add(new CraftingRecipe(new String[][] {
      ...
      { "Dirt", "Dirt", "Dirt" } }, new TntItem(1), new int[1], 
      new int[1]));
  }
}
