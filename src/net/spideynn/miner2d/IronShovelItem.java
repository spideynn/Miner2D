...
public class IronShovelItem extends Item implements Serializable {

	private static final long serialVersionUID = -2390601950259204992L;

	public IronShovelItem() {
		super(1, 1, 28, false, "Iron Shovel", false, 0);
		this.tool = true;
		this.usage = 8192;
	}
	...
	public Item copyitem() {
		IronShovelItem copy = new IronShovelItem();
