...
public class RubyOre extends Tile implements Serializable {

	public RubyOre() {
		super(12, true, false, true, true);
	}
	
	private static final long serialVersionUID = -4265225967304549342L;
