...
import net.spideynn.miner2d.ItemMethods;

public abstract class Item implements ItemMethods, Serializable {
	...
	public Item(int stack, int maxstack, int img, boolean placeable,
			String name, boolean smeltable, int smeltlast) {
		this.stack = stack;
